...
const AddService = () => {
    ...
    const onSubmit = review => {
        fetch('https://ibrars-smile.herokuapp.com/reviews', {
            method: 'POST',
            headers: {
            ...
            <div className=" mx-auto mt-4 text-center">
                ...
                <form className="flex flex-col w-100" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='items-center justify-center flex'>
                        <button onClick={handleClick} className='button-review w-60 text-center ' type="submit" value="Add Review">Add Review <i className="fa-solid fa-check ico"></i></button>
                    </div>
